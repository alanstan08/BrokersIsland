            ...
            <div className="row g-4 py-5 row-cols-1 row-cols-lg-3 m-5">
                <div className="feature col">
                    <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                        <img className='' src='https://imageio.forbes.com/specials-images/imageserve/61094e6051bb4a2bacce5663/real-estate-investing/960x0.jpg?height=473&width=711&fit=bounds'  max-height='100%' max-width='100%' />
                    </div>
                ...
                <div className="feature col">
                    <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3 ">
                        <img className='' src='https://media.licdn.com/dms/image/C5112AQG1cc41Na3mFw/article-cover_image-shrink_720_1280/0/1520120395314?e=2147483647&v=beta&t=WmMkTak20vQgi5b9HqBD_N3CESWPkpae4AFS3xMNR9o'  max-height='100%' max-width='100%' />
                    </div>
                ...
                <div className="feature col">
                    <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                        <img className='' src='https://valuepersqft.com/wp-content/uploads/2023/07/real-estate-consultant-service.jpg' max-height='100%' max-width='100%' />
                    </div>
                    <h3 className="fs-2 text-body-emphasis">Expert Real Estate Guidance</h3>
                    <p>Our team of real estate experts provides valuable insights and guidance to help you make informed decisions. We assist you in identifying properties with the best return on investment, ensuring that your real estate investments align with your financial objectives.</p>
                    <button className='btn btn-info'>
                        learn more
                    </button>
                </div>
